<script setup>
    ...
    function confirmArrival() {
        ...
        .then(response => {
            alert(response)
            curr_page = 0
            fetch('http://localhost:8080/parcel/incoming/from-distribution-base?page=' + 0,{
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    function nextPage() {
        ...
        fetch('http://localhost:8080/parcel/incoming/from-distribution-base?page=' + curr_page,{
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
<template>
    <h1>PARCEL PENDING FROM DEPOS</h1>
    <div id="nav">
