<script setup>
    ...
    function sendToBase() {
        ...
        fetch('http://localhost:8080/parcel/to-transaction-base', {
            method: 'PUT',
            headers: {
    ...
    function nextPage() {
        ...
        fetch('http://localhost:8080/parcel/to-transaction-base?page=' + curr_page,{
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
