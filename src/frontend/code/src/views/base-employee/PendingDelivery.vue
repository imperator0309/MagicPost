<script setup>
    ...
    function deliverParcel() {
        ...
        fetch('http://localhost:8080/parcel/to-receiver/in-queue', {
            method: 'PUT',
            headers: {
        ...
        .then(response => {
            alert(response)
            curr_page = 0
            fetch('http://localhost:8080/parcel/to-receiver/in-queue?page=0',{
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    function nextPage() {
        ...
        fetch('http://localhost:8080/parcel/to-receiver/in-queue?page=' + curr_page,{
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
