<script>
import AddAccount from '@/views/base-manager/AddAccount.vue';
import EmployeeTable from '@/views/base-manager/EmployeeTable.vue';
import EditAccount from '@/views/base-manager/EditAccount.vue';
import BaseDialog from '@/views/base-manager/BaseDialog.vue'
