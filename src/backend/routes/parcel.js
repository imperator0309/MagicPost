...
router.get('/distribution-base/to-receiver/in-queue', ParcelController.showToTransactionBaseInQueue)

router.post('/transaction-base/create', ParcelController.createParcel)

router.put('/transaction-base/to-distribution-base', ParcelController.forwardToDistributionBase)
...
router.put('/distribution-base/to-receiver/in-queue', ParcelController.forwardToTransactionBase)
